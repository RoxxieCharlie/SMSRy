...
# Local runserver should serve app static files when no .env is present.
...
CSRF_FAILURE_VIEW = "store.views.auth.csrf_failure"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "store.context_processors.store_nav_context",
            ],
        },
    },
]
